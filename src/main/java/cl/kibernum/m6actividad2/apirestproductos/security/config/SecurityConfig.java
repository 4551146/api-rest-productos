package cl.kibernum.m6actividad2.apirestproductos.security.config;


// Manejador centralizado para respuestas 401/403 en formato JSON.
import cl.kibernum.m6actividad2.apirestproductos.security.exception.SecurityExceptionHandler;
// Filtro que valida el JWT en cada request y establece la autenticación en el contexto.
import cl.kibernum.m6actividad2.apirestproductos.security.filter.JwtAuthenticationFilter;
// Propiedades externas de seguridad (secret, issuer, TTLs, CORS, etc.).
import cl.kibernum.m6actividad2.apirestproductos.security.jwt.JwtProperties;
...
public class SecurityConfig {
     ...
     * - Reglas de autorización para /api/productos y apertura de /api/auth/** y H2.
